<h1 id="Malaysia-E-invoice-2026-06"><span style="color: blue;">Malaysia E-Invoice</span></h1>
...
<h2 id="Setup-Malaysia-E-invoice-2026-06">Setup MyInvois in EasyParcel</h2>
...
`POST https://api.easyparcel.com/open_api/2026-06/einvoice/malaysia/verify_access`
...
<h2 id="Submit-Malaysia-E-invoice-2026-06">Submit Malaysia E-Invoice</h2>
...
<h2 id="Http-Request-Malaysia-E-invoice-2026-06">HTTP Request(Malaysia MyInvois)</h2>

### Endpoint

`POST https://api.easyparcel.com/open_api/2026-06/einvoice/malaysia/submit`
